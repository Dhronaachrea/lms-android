...
public class FiveGameScreen extends Fragment implements DismissListener, WebServicesListener {
    ...
    private void lagosBetTypeUpdate(JSONObject betObject, String[] favArr, LotteryPreferences
        ...
        try {
            switch (betObject.getInt("betCode")) {
                ...
                case 1:
                case 19:
                    lastPicked = betObject.getInt("betCode") == 1 ? lotteryPreferences.getDIRECT_1().split(",") : lotteryPreferences.getMN_DIRECT1().split(",");
                ...
                case 2:
                case 20:
                    lastPicked = betObject.getInt("betCode") == 2 ? lotteryPreferences.getDIRECT_2().split(",") : lotteryPreferences.getMN_DIRECT2().split(",");
                ...
                case 3:
                case 21:
                    lastPicked = betObject.getInt("betCode") == 3 ? lotteryPreferences.getDIRECT_3().split(",") : lotteryPreferences.getMN_DIRECT3().split(",");
                ...
                case 4:
                case 22:
                    lastPicked = betObject.getInt("betCode") == 4 ? lotteryPreferences.getDIRECT_4().split(",") : lotteryPreferences.getMN_DIRECT4().split(",");
                ...
                case 5:
                case 23:
                    lastPicked = betObject.getInt("betCode") == 5 ? lotteryPreferences.getDIRECT_5().split(",") : lotteryPreferences.getMN_DIRECT5().split(",");
                ...
                case 6:
                case 24:
                    lastPicked = betObject.getInt("betCode") == 6 ? lotteryPreferences.getPERM_2().split(",") : lotteryPreferences.getMN_PERM2().split(",");
                ...
                case 7:
                case 25:
                    lastPicked = betObject.getInt("betCode") == 7 ? lotteryPreferences.getPERM_3().split(",") : lotteryPreferences.getMN_PERM3().split(",");
                ...
                case 8:
                case 26:
                    lastPicked = betObject.getInt("betCode") == 8 ? lotteryPreferences.getBANKER().split(",") : lotteryPreferences.getMN_BANKER().split(",");
//                    String[] lastPicked = {"39", "40", "46", "UL", "20", "21", "31", "1", "3", "20", "21", "11", "BL"};
                ...
                case 9:
                case 27:
                    lastPicked = betObject.getInt("betCode") == 9 ? lotteryPreferences.getBANKER_1_AGAINST_ALL().split(",") : lotteryPreferences.getMN_BANKER1AGAINSTALL().split(",");
                ...
                //DC-Perm3
                case 16:
                    bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 4, 20, new String[]{}, favArr, lotteryPreferences.getDC_Perm3().split(","));//Dc-perm3
                    bean.setMaxBetAmtAndUnitPrice(setMaxUnitPriceVal(bean), setUnitPriceVal(bean, bean.getMinNo()));
                    bean.setBetName(betObject.optString("betDispName"));
                    betTypeData.put(bean.getBetDisplayName(), bean);
                    break;
                case 12:
                    bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 3, 3, new String[]{}, favArr, lotteryPreferences.getDC_DIRECT3().split(","));//DC-Direct3
                    bean.setMaxBetAmtAndUnitPrice(setMaxUnitPriceVal(bean), setUnitPriceVal(bean, bean.getMinNo()));
                    bean.setBetName(betObject.optString("betDispName"));
                    betTypeData.put(bean.getBetDisplayName(), bean);
                    break;
                case 10:
                    bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 10, 10, new String[]{}, favArr, lotteryPreferences.getPERM_1().split(","));//PERM1
                    bean.setMaxBetAmtAndUnitPrice(setMaxUnitPriceVal(bean), setUnitPriceVal(bean, bean.getMinNo()));
                    bean.setBetName(betObject.optString("betDispName"));
                    betTypeData.put(bean.getBetDisplayName(), bean);
                    break;
                case 11:
                    bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 2, 2, new String[]{}, favArr, lotteryPreferences.getDC_Direct2().split(","));//DC_Direct2
                    bean.setMaxBetAmtAndUnitPrice(setMaxUnitPriceVal(bean), setUnitPriceVal(bean, bean.getMinNo()));
                    bean.setBetName(betObject.optString("betDispName"));
                    betTypeData.put(bean.getBetDisplayName(), bean);
                    break;
                case 15:
                    bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 3, 20, new String[]{}, favArr, lotteryPreferences.getDC_Perm2().split(","));//DC_Perm2
                    bean.setMaxBetAmtAndUnitPrice(setMaxUnitPriceVal(bean), setUnitPriceVal(bean, bean.getMinNo()));
                    bean.setBetName(betObject.optString("betDispName"));
                    betTypeData.put(bean.getBetDisplayName(), bean);
                    break;
...
//            new DGETask(FiveGameScreen.this, "BUY", url, ticketSaleDta.toString()).execute();
//        } catch (JSONException e) {
//            e.printStackTrace();
//        }
//    }
...
//                        }
                        ...
                        if (jsonResult.getInt("responseCode") == 0) {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                if (jsonObject.getString("gameCode").equals(Config.fiveGameName)) {
                                    ...
                                    for (int j = 0; j < jsonArray.length(); j++) {
                                        ...
                                        String time = advDrawObj.getString("drawDateTime");
                                        if (!gameObject.optString("MinBetAmountMultipleForDc").equalsIgnoreCase(""))
                                            MinBetAmountMultipleForDc = jsonObject.getDouble("MinBetAmountMultipleForDc"); //arushi
                                        String drawTime = time.split(" ")[0] + " " + time.split(" ")[1].split(":")[0] + ":" + time.split(" ")[1].split(":")[1];
                                    ...
                                    restDraws.setVisibility(View.INVISIBLE);
                                    showOne = false;
                                    darwDialog = new DrawDialog(activity, drawDatas, FiveGameScreen.this, false);
                ...
                case R.id.buy_now:
                    if (buyNow.getText().toString().equalsIgnoreCase("Next")) {
                        if (DataSource.Keno.numbersSelected >= selectedBetBean.getMinNo()) {
                            isNext = true;
                            ((DGPlayActivity) activity).isNext(isNext, FiveGameScreen.this);
//                            selectedBetBean.setCurrentNos(getPickedNo());
                        ...
                        if (DataSource.Keno.numbersSelected >= selectedBetBean
                                .getMinNo()) {
                            selectedBetBean.setCurrentNos(getPickedNo());
                            ((DGPlayActivity) activity).isNext(false, FiveGameScreen.this);
...
//                }
    ...
    class CounterValueIncDec implements Runnable {
        ...
        public CounterValueIncDec(int id) {
            this.currentID = id;
        }
        ...
        public void run() {
            if (hide_keyboard(activity, selectedBetBean))
                if (isIncremented) {
                    if (currentID == R.id.inc) {
                        incDecHandler(selectedBetBean.getUnitPrice(),
                                selectedBetBean.getMaxBetAmtMulUnitPrice(),
                                selectedBetBean.getUnitPrice(), R.id.inc, unitPrice,
                                true);
                        onLongPressCounterHandler.postDelayed(new CounterValueIncDec(currentID),
                                100);
                    } else if (currentID == R.id.qp_inc) {
                        hide_keyboard(activity);
                        incDecHandler(numberSelected + 1,
                                selectedBetBean.getMaxNo(), 1, R.id.qp_inc, qpNos,
                                false);
