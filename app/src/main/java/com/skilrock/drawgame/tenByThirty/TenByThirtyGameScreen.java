 ...
 */
public class TenByThirtyGameScreen extends Fragment implements DismissListener, WebServicesListener {
        ...
        advanceDrawMenu.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                darwDialog = new DrawDialog(activity, drawDatas,
                        TenByThirtyGameScreen.this, false);
...
//                                            + activity.getResources().getString(R.string.numb_five), Toast.LENGTH_SHORT);
//                        }
//                    } else {
//                        if (drawName.getText().toString().equals(activity.getString(R.string.no_draws_text))) {
//                            Utils.Toast(activity, activity.getString(R.string.no_draws_text), Toast.LENGTH_SHORT);
...
//        });
    ...
    private void buyNow() {
        ...
        try {
            ticketSaleDta.put("gameCode", Config.tenByThirty);
            ...
            new DGETask(TenByThirtyGameScreen.this, "BUY", url, ticketSaleDta.toString()).execute();
                ...
                if (selectNos.isChecked()) {
                    ...
                    unitLay.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            gridView.setAdapter(new ButtonAdapter(TenByThirtyGameScreen.this,
                                    (int) widthForGridChild / 6, (int) widthForGridChild / 6,
                                    textSize, selectedBetBean, 5));
                            openGrid(gridView, true);
...
//                String[] lastPicked = betObject.getString("lastPicked").split(",");
                ...
                switch (betObject.getInt("betCode")) {
                    case 1://Direct10
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 10, 10, new String[]{}, favArr, lotteryPreferences.getDIRECT_10_TEN_THIRTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                    case 2://First10
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 10, 10, new String[]{}, favArr, lotteryPreferences.getFIRST_10_TEN_THIRTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                    case 3://Middle10
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 10, 10, new String[]{}, favArr, lotteryPreferences.getMIDDLE_10_TEN_THIRTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                    case 4://Last10
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 10, 10, new String[]{}, favArr, lotteryPreferences.getLAST_10_TEN_THIRTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
