 ...
 */
public class TenByEightyGameScreen extends Fragment implements DismissListener, WebServicesListener {
        ...
        advanceDrawMenu.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                darwDialog = new DrawDialog(activity, drawDatas,
                        TenByEightyGameScreen.this, false);
...
//                betName.setText(BetDialog.selectedBet);
    ...
    private void inputEvents() {
        ...
        qpInc.setOnClickListener(commonClickListener);
        qpDec.setOnClickListener(commonClickListener);
        inc.setOnClickListener(commonClickListener);
        dec.setOnClickListener(commonClickListener);
    }
    ...
    private void buyNow() {
        ...
        try {
            ticketSaleDta.put("gameCode", Config.tenByEighty);
            ...
            new DGETask(TenByEightyGameScreen.this, "BUY", url, ticketSaleDta.toString()).execute();
                ...
                if (selectNos.isChecked()) {
                    ...
                    unitLay.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            gridView.setAdapter(new ButtonAdapter(TenByEightyGameScreen.this,
                                    (int) widthForGridChild / 10, ((int) heightForGridChild - unitLayheight) / 8,
                                    textSize, selectedBetBean, 8));
                            openGrid(gridView, true);
                        }
                    });
        ...
        try {
            ...
            for (int i = 0; i < betTypeArr.length(); i++) {
                ...
                switch (betObject.getInt("betCode")) {
                    case 1://Direct1
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 1, 1, new String[]{}, favArr, lotteryPreferences.getDIRECT_1_TEN_BY_EIGHTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                    case 2://Direct2
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 2, 2, new String[]{}, favArr, lotteryPreferences.getDIRECT_2_TEN_BY_EIGHTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                    case 3://Direct3
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 3, 3, new String[]{}, favArr, lotteryPreferences.getDIRECT_3_TEN_BY_EIGHTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                    case 4://Direct4
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 4, 4, new String[]{}, favArr, lotteryPreferences.getDIRECT_4_TEN_BY_EIGHTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                    case 5://Direct5
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 5, 5, new String[]{}, favArr, lotteryPreferences.getDIRECT_5_TEN_BY_EIGHTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                    case 6://Direct6
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 6, 6, new String[]{}, favArr, lotteryPreferences.getDIRECT_6_TEN_BY_EIGHTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                    case 7://Direct7
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 7, 7, new String[]{}, favArr, lotteryPreferences.getDIRECT_7_TEN_BY_EIGHTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                    case 8://Direct8
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 8, 8, new String[]{}, favArr, lotteryPreferences.getDIRECT_8_TEN_BY_EIGHTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                    case 9://Direct9
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 9, 9, new String[]{}, favArr, lotteryPreferences.getDIRECT_9_TEN_BY_EIGHTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                    case 10://Direct10
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 10, 10, new String[]{}, favArr, lotteryPreferences.getDIRECT_10_TEN_BY_EIGHTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                }
