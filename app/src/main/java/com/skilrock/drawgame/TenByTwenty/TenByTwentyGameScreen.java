package com.skilrock.drawgame.TenByTwenty;
...
/**
 * Created by stpl on 9/29/2016.
 */
public class TenByTwentyGameScreen extends Fragment implements DismissListener, WebServicesListener {
...
//        context = getActivity();
        ...
        analytics.setScreenName(Fields.Screen.TEN_THIRTY_GAME_SCREEN);
        analytics.sendAction(Fields.Category.UX, Fields.Action.OPEN);
        DataSource.numbers = new int[20];
        ...
        advanceDrawMenu.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                darwDialog = new DrawDialog(activity, drawDatas,
                        TenByTwentyGameScreen.this, false);
...
//                betName.setText(BetDialog.selectedBet);
        ...
        View.OnClickListener okay = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (GlobalVariables.connectivityExists(activity)) {
                    analytics.sendAction(Fields.Category.TEN_BY_THIRTY_PURCHASE, Fields.Action.CLICK);
                    dBox.dismiss();
                    buyNow();
                } else {
    ...
    private void buyNow() {
        ...
        try {
            ticketSaleDta.put("gameCode", Config.tenByTwenty);
            ...
            new DGETask(TenByTwentyGameScreen.this, "BUY", url, ticketSaleDta.toString()).execute();
...
//            setEditVisible(View.GONE);//old
    ...
    private void updateUI(View view) {
        switch (view.getId()) {
            case R.id.fav_nos:
                analytics.sendAll(Fields.Category.TEN_BY_THIRTY_GAME, Fields.Action.CLICK, Fields.Label.FAV_NO);
            ...
            case R.id.last_picked:
                analytics.sendAll(Fields.Category.TEN_BY_THIRTY_GAME, Fields.Action.CLICK, Fields.Label.LAST_PICK);
                playInfoLay.setVisibility(View.GONE);
                setEditVisible(View.INVISIBLE);
                // Utils.Toast(activity,
                // ((CustomCheckedTextView) view).getText().toString(),
            ...
            case R.id.quick_pick:
                analytics.sendAll(Fields.Category.TEN_BY_THIRTY_GAME, Fields.Action.CLICK, Fields.Label.QUICK_PICK);
                playInfoLay.setVisibility(View.GONE);
                setEditVisible(View.INVISIBLE);
                // Utils.Toast(activity,
                // ((CustomCheckedTextView) view).getText().toString(),
            ...
            case R.id.select_nos:
                analytics.sendAll(Fields.Category.TEN_BY_THIRTY_GAME, Fields.Action.CLICK, Fields.Label.PICK_NEW);
                if (selectNos.isChecked()) {
                    ...
                    unitLay.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            gridView.setAdapter(new ButtonAdapter(TenByTwentyGameScreen.this,
                                    (int) widthForGridChild / 5, (int) widthForGridChild / 5,
                                    textSize, selectedBetBean, 7));
                            openGrid(gridView, true);
...
//                            textSize, selectedBetBean));
    ...
    public void gameAmtCalculation(BetTypeBean bean) {
        int minNo = 0;
        if (bean.getBetCode() == 1 || bean.getBetCode() == 2 || bean.getBetCode() == 3 || bean.getBetCode() == 4)
            minNo = 10;
        noOfLinesVal = 0;
        totalAmt = 0;
...
//                String[] lastPicked = betObject.getString("lastPicked").split(",");
                ...
                switch (betObject.getInt("betCode")) {
                    //direct10 last10 first10 allodd alleven oddeven evenodd jumpoddenven jumpevenodd
                    case 1://Direct10
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 10, 10, new String[]{}, favArr, lotteryPreferences.getDIRECT_10_TEN_BY_TWENTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                    case 2://first10
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 10, 10, new String[]{}, favArr, lotteryPreferences.getFIRST_10_TEN_BY_TWENTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                    case 3://last10
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 10, 10, new String[]{}, favArr, lotteryPreferences.getLAST_10_TEN_BY_TWENTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                    case 4://allodd
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 10, 10, new String[]{}, favArr, lotteryPreferences.getALLODD_TEN_BY_TWENTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                    case 5://alleven
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 10, 10, new String[]{}, favArr, lotteryPreferences.getALLEVEN_TEN_BY_TWENTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                    case 6://oddeven
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 10, 10, new String[]{}, favArr, lotteryPreferences.getODDEVEN_TEN_BY_TWENTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                    case 7://evenodd
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 10, 10, new String[]{}, favArr, lotteryPreferences.getEVENODD_TEN_BY_TWENTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                    case 8://jumpoddenven
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 10, 10, new String[]{}, favArr, lotteryPreferences.getJUMP_ODD_EVEN_TEN_BY_TWENTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                    case 9://jumpevenodd
                        bean = new BetTypeBean(betObject.getDouble("unitPrice"), betObject.getInt("maxBetAmtMul"), betObject.optString("betName").equalsIgnoreCase("") ? betObject.optString("betDispName") : betObject.optString("betName"), betObject.getInt("betCode"), 10, 10, new String[]{}, favArr, lotteryPreferences.getJUMP_EVEN_ODD_TEN_BY_TWENTY().split(","));
                        bean.setBetName(betObject.optString("betDispName"));
                        betTypeData.put(bean.getBetDisplayName(), bean);
                        break;
                }
                ...
                if (resultData != null) {
                    try {
                        ...
                        if (jsonResult.getInt("responseCode") == 0) {
                            analytics.sendAll(Fields.Category.TEN_BY_THIRTY_PURCHASE, Fields.Action.RESULT, Fields.Label.SUCCESS);
                            ...
                            analytics.sendAll(Fields.Category.TEN_BY_THIRTY_PURCHASE, Fields.Action.RESULT, Fields.Label.FAILURE);
