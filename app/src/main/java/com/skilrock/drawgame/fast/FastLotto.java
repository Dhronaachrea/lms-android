...
public class FastLotto extends Fragment implements WebServicesListener {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        mainView = inflater.inflate(R.layout.fast_lotto_fragment, null);
...
//        setCounterDownTimer();
        ...
        playNow.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                analytics.sendAll(Fields.Category.FAST_GAME, Fields.Action.CLICK, Fields.Label.BUY);
        ...
        itemGrid.setAdapter(new GamePageGridAdapter(getActivity(),
                ...
                (int) widthForGridChild / 2, mainMenuData, getResources().getColor(R.color.fast_theme_color)));
                ...
                switch (position) {
                    case 0:
                        ...
                        if (GlobalVariables.connectivityExists(getActivity())) {
                            ...
                            new DGETask(FastLotto.this, "GET_STATS", url, json).execute();
                        } else {
                    ...
                    case 1:
                        ...
                        if (GlobalVariables.connectivityExists(getActivity())) {
                            ...
                            new DGETask(FastLotto.this, "GET_RESULTS", urlRes, jsonRes).execute();
                        } else {
    ...
    private void getDisplayDetails() {
        ...
        Utils.logPrint("data-" + ballHeight + " " + width + " " + heightForGridChild + " "
                + widthForGridChild);
    }
                ...
                if (resultData != null) {
                    try {
                        ...
                        if (jsonResult.getInt("responseCode") == 0) {
                            ...
                            statsIntent.putExtra("gameId", Config.fastGameName);
