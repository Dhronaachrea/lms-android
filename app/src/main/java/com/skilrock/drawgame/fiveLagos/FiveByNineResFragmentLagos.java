...
public class FiveByNineResFragmentLagos extends Fragment {
    ...
    public FiveByNineResFragmentLagos(FiveByNineResultBean resultBean) {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        mainView = inflater.inflate(R.layout.five_by_nine_res_frag, null);
