...
public class FiveByNineLagos extends Fragment implements WebServicesListener {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        mainView = inflater.inflate(R.layout.five_fragment_lagos, null);
        bindViewIds(mainView);
        bannerView.setImageResource(R.drawable.sub_banner_five_lagos);
...
//        imageLoader.init(ImageLoaderConfiguration.createDefault(getActivity()));
        ...
        // imageListener);
        itemGrid.setAdapter(new GamePageGridAdapter(getActivity(), R.layout.menu_row, (int) heightForGridChild / 2, (int) widthForGridChild / 2, mainMenuData, getResources().getColor(R.color.five_theme_color)));
        ...
        statView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DGETask(FiveByNineLagos.this, "GET_STATS", url, json).execute();
            }
        });
        resultView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DGETask(FiveByNineLagos.this, "GET_RESULTS", urlRes, jsonRes).execute();
            }
        });
                ...
                if (resultData != null) {
                    try {
                        ...
                        if (jsonResult.getInt("responseCode") == 0) {
                            ...
                            statsIntent.putExtra("gameId", Config.fiveGameNameLagos);
