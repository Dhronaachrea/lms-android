...
public interface IGEManualScratchView {
    ...
    /**
     * If true, set the view allow receive on touch to reveal the view By
     * default, scratchable is true
     *
    ...
    /**
     * Set turn on/off effect of anti alias of circle revealed By default, anti
     * alias is turn off
     *
