 ...
 * @author winsontan520
 */
public class WScratchView extends SurfaceView implements IGEManualScratchView,
        SurfaceHolder.Callback {
    public static final int DEFAULT_SCRATCH_TEST_SPEED = 25;
    private static final String TAG = "WScratchView";
    public static int viewWidth, viewHeight;
    public static float rectDivX1, rectDivX2, rectDivY1, rectDivY2;
    public static float rectX1, rectX2, rectY1, rectY2;
        ...
        if (mScratchBitmap != null) {
            if (mMatrix == null) {
                float scaleWidth = (float) canvas.getWidth()
                        / mScratchBitmap.getWidth();
                float scaleHeight = (float) canvas.getHeight()
                        / mScratchBitmap.getHeight();
                mMatrix = new Matrix();
...
//                        if (me.getX() > rectX1 && me.getX() < rectX2
//                                && me.getY() > rectY1 && me.getY() < rectY2) {
...
//                        }
    ...
    public void surfaceCreated(SurfaceHolder arg0) {
        ...
        mScratchedTestBitmap = Bitmap.createBitmap(arg0.getSurfaceFrame()
                        .width(), arg0.getSurfaceFrame().height(),
                Bitmap.Config.ARGB_8888);
        viewWidth = mScratchedTestBitmap.getWidth();
        viewHeight = mScratchedTestBitmap.getHeight();
        rectX1 = (float) (viewWidth / rectDivX1);
        rectX2 = (float) (viewWidth / rectDivX2);
        rectY1 = (float) (viewHeight / rectDivY1);
        rectY2 = (float) (viewHeight / rectDivY2);
